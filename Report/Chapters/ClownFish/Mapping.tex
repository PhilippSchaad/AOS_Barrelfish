...
\todo{mention the possibility of pools? was meint ihr? im code haben wir da 
noch eine bemerkung, dass das sinnvoll sein könnte, damit nicht laufend neue 
caps erstellt werden müssen. soll ich das noch erwähnen?}
