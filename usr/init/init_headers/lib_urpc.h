...
inline struct event_closure_with_arg init_event_closure_with_arg(void(*func)(void*,void*),void* savedarg) {
...
//returns a urpc2_data with the data field owned by this instance and needing to be freed
...
//the recv_list owns data alloced at -2 relative to the where the ->data thing points. Needs to be freed
